...
@ stdcall NtGdiConfigureOPMProtectedOutput(ptr ptr long ptr)
...
@ stdcall NtGdiCreateOPMProtectedOutputs(ptr long long ptr ptr)
...
@ stdcall NtGdiGetCertificate(ptr ptr long ptr)
@ stdcall NtGdiGetCertificateSize(ptr ptr ptr)
...
@ stdcall NtGdiGetSuggestedOPMProtectedOutputArraySize(ptr ptr)
...
@ stdcall NtUserDoSoundConnect()
@ stdcall NtUserDoSoundDisconnect()
...
@ stdcall NtUserFrostCrashedWindow(ptr long)
...
@ stdcall NtUserLogicalToPhysicalPoint(ptr ptr)
...
@ stdcall NtUserSwitchDesktop(ptr long)
