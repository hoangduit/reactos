...
<xsl:template match="section">
  ...
  <div xmlns="http://www.w3.org/1999/xhtml" class="{name(.)}">
    ...
    <xsl:if test="(contains($toc.params, 'toc')                    and $depth &lt;= $generate.section.toc.level)                   or refentry">
...
<xsl:template match="sect1">
  <div xmlns="http://www.w3.org/1999/xhtml" class="{name(.)}">
    ...
    <xsl:if test="(contains($toc.params, 'toc')                    and $generate.section.toc.level &gt;= 1)                   or refentry">
      <xsl:call-template name="section.toc"/>
    </xsl:if>
    <xsl:apply-templates/>
    <xsl:call-template name="process.chunk.footnotes"/>
...
<xsl:template match="sect2">
  <div xmlns="http://www.w3.org/1999/xhtml" class="{name(.)}">
    ...
    <xsl:if test="(contains($toc.params, 'toc')                    and $generate.section.toc.level &gt;= 2)                   or refentry">
      <xsl:call-template name="section.toc"/>
    </xsl:if>
    <xsl:apply-templates/>
  </div>
...
<xsl:template match="sect3">
  <div xmlns="http://www.w3.org/1999/xhtml" class="{name(.)}">
    ...
    <xsl:if test="(contains($toc.params, 'toc')                    and $generate.section.toc.level &gt;= 3)                   or refentry">
      <xsl:call-template name="section.toc"/>
    </xsl:if>
    <xsl:apply-templates/>
  </div>
...
<xsl:template match="sect4">
  <div xmlns="http://www.w3.org/1999/xhtml" class="{name(.)}">
    ...
    <xsl:if test="(contains($toc.params, 'toc')                    and $generate.section.toc.level &gt;= 4)                   or refentry">
      <xsl:call-template name="section.toc"/>
    </xsl:if>
    <xsl:apply-templates/>
  </div>
...
<xsl:template match="sect5">
  <div xmlns="http://www.w3.org/1999/xhtml" class="{name(.)}">
    ...
    <xsl:if test="(contains($toc.params, 'toc')                    and $generate.section.toc.level &gt;= 5)                   or refentry">
      <xsl:call-template name="section.toc"/>
    </xsl:if>
    <xsl:apply-templates/>
  </div>
