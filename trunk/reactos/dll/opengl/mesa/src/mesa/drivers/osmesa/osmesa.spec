...
@ stdcall OSMesaColorClamp(long)
@ stdcall OSMesaCreateContext(long ptr)
@ stdcall OSMesaCreateContextExt(long long long long ptr)
@ stdcall OSMesaDestroyContext(ptr)
@ stdcall OSMesaMakeCurrent(ptr ptr long long long)
@ stdcall OSMesaGetCurrentContext()
@ stdcall OSMesaPixelStore(long long)
@ stdcall OSMesaGetIntegerv(long ptr)
@ stdcall OSMesaGetDepthBuffer(ptr ptr ptr ptr ptr)
@ stdcall OSMesaGetColorBuffer(ptr ptr ptr ptr ptr)
@ stdcall OSMesaGetProcAddress(str)