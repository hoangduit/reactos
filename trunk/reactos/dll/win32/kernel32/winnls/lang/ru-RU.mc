...
Language=Russian
ERROR_BAD_NETPATH - Сетевой путь не найден.
.
...
Language=Russian
ERROR_BAD_NET_NAME - Сетевое имя не найдено.
.
...
Language=Russian
ERROR_CANNOT_MAKE - Не удалось создать файл или директорию.
.
...
Language=Russian
ERROR_INVALID_PARAMETER - Некорректный параметр.
.
...
Language=Russian
ERROR_BUFFER_OVERFLOW - Имя файла слишком длинное.
.
